...
// Guide editor (admin) - Polish drafted for review by the author
  geTitle:        { en: "Edit guides", pl: "Edytuj przewodniki" },
  geIntro:        { en: "Update guide content and the last-reviewed date. Changes go live immediately and fall back to the built-in default if reset.", pl: "Zaktualizuj treść przewodnika i date ostatniej weryfikacji. Zmiany sa widoczne od razu, a po zresetowaniu przywracana jest wersja domyslna." },
  geEdit:         { en: "Edit", pl: "Edytuj" },
  geBack:         { en: "Back to list", pl: "Powrot do listy" },
  geEdited:       { en: "edited", pl: "edytowano" },
  geTitleEn:      { en: "Title (English)", pl: "Tytul (angielski)" },
  geTitlePl:      { en: "Title (Polish)", pl: "Tytul (polski)" },
  geSummaryEn:    { en: "Summary (English)", pl: "Podsumowanie (angielski)" },
  geSummaryPl:    { en: "Summary (Polish)", pl: "Podsumowanie (polski)" },
  geSource:       { en: "Official source URL", pl: "Adres oficjalnego zrodla" },
  geUpdated:      { en: "Last reviewed", pl: "Ostatnia weryfikacja" },
  geSteps:        { en: "Steps", pl: "Kroki" },
  geStepHeadEn:   { en: "Step heading (English)", pl: "Naglowek kroku (angielski)" },
  geStepHeadPl:   { en: "Step heading (Polish)", pl: "Naglowek kroku (polski)" },
  geStepBodyEn:   { en: "Step text (English)", pl: "Tresc kroku (angielski)" },
  geStepBodyPl:   { en: "Step text (Polish)", pl: "Tresc kroku (polski)" },
  geSave:         { en: "Save changes", pl: "Zapisz zmiany" },
  geCancel:       { en: "Cancel", pl: "Anuluj" },
  geResetDefault: { en: "Reset to default", pl: "Przywroc domyslne" },
  geSaved:        { en: "Saved - changes are live.", pl: "Zapisano - zmiany sa aktywne." },
  geReset:        { en: "Reset to the built-in version.", pl: "Przywrocono wersje wbudowana." },
  geError:        { en: "Could not save. Please try again.", pl: "Nie udalo sie zapisac. Sprobuj ponownie." },
  geResetConfirm: { en: "Reset this guide to its built-in default and discard your edits?", pl: "Przywrocic ten przewodnik do wersji domyslnej i odrzucic zmiany?" },
};
